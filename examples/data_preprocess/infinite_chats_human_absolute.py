...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="~/data/infinite-chats-human-absolute", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()
    local_dataset_path = args.local_dataset_path

    data_source = "liweijiang/infinite-chats-human-absolute"
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            question_raw = example["user_query"]
            data = {
