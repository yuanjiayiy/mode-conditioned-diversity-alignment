...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="~/data/infinite-chats-taxonomy", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()
    local_dataset_path = args.local_dataset_path

    data_source = "liweijiang/infinite-chats-taxonomy"
    ...
    if "response_type" in dataset.features:
        filtered_dataset = dataset.filter(lambda x: x["response_type"] == "multiple")
    else:
