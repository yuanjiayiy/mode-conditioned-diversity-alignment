...
class Tracking:
    ...
    def log_artifact(
        ...
        *,
        ...
        No-op unless the `wandb` backend is enabled.

        Args:
            path: File or directory path to upload.
            name: Artifact name (WandB will version it automatically).
            artifact_type: Artifact type, e.g. "model", "dataset", "checkpoint".
            aliases: Optional aliases, e.g. ["latest", "step-100"].
